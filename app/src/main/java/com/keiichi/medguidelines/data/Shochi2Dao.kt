...
interface Shochi2Dao {
    ...
    @androidx.room.Query("SELECT shochi1_name FROM shochi2_master WHERE mdc_code = :mdcCode AND bunrui_code = :bunruiCode")
    ...
    @androidx.room.Query("SELECT taiou_code FROM shochi1_master WHERE shochi2_name = :name LIMIT 1")
