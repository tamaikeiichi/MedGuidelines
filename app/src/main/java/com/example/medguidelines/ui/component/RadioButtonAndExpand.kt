    ...
    //        ),
            ...
            Row(
                ...
                Column (
                    ...
                    //Text(text = Html.fromHtml(title, FROM_HTML_MODE_LEGACY).toString(),
                    val htmlAnnotatedString = Html.fromHtml(title, FROM_HTML_MODE_LEGACY)
                    //val htmlAnnotatedString = convertHtmlWithSubscriptToAnnotatedString(title)
                    Text(text = AnnotatedString(htmlAnnotatedString.toString()),
                        Modifier
                            .padding(10.dp))
                    if (expanded) {
                        Text (text = titleNote,
